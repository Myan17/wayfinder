...
owner: myan
paths:
  - apps/ingestd/internal/chunk/**
  - docs/context/modules/chunking.md
interface_files:
  - apps/ingestd/internal/chunk/chunk.go
tables_owned:
  - content
depends_on:
  - sources
design_sections:
  - "DESIGN §9.4 (chunking and representation identity)"
verified_at: 0000000
...
> **Whoever implements `chunking` fills it in, in the pull request that lands the first interface file**
...
Splits sources into leaf and residual chunks with deterministic headers, and reports everything it skipped.
