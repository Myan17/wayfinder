...
paths:
  - eval/harness/**
  - eval/experiments/**
  - docs/context/modules/eval-harness.md
interface_files:
  - eval/harness/interface.py
  - eval/experiments/schema.json
tables_owned:
  []
depends_on:
  - retrieval
  ...
  - eval-data
design_sections:
  - "DESIGN §15 (evaluation methodology)"
  - "DESIGN §16.5 (quality gates)"
verified_at: 0000000
...
> **Whoever implements `eval-harness` fills it in, in the pull request that lands the first interface file**
...
Metrics, intervals, experiment runner and the CI regression gate.
