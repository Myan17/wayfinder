...
| 2 | Schema v1: authorization facts, three identities, generations, tombstones | 3 | The most expensive thing to change later; `gupta958`'s first P0 review focus | in review #25–#28; `db/schema.sql` pending |
